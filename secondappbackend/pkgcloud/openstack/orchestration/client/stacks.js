...
exports.getStack = function (stack, callback) {
  var self = this,
    path = stack instanceof orchestration.Stack
      ? new URL(_urlPrefix, stack.name, stack.id)
      : new URL(_urlPrefix, stack);
...
exports.createStack = function (details, callback) {
  ...
  var self = this,
    createOptions = {
      method: 'POST',
      path: details.preview ? new URL(_urlPrefix, 'preview'): _urlPrefix,
      body: {
...
exports.updateStack = function (stack, callback) {
  ...
  return this._request({
    path: new URL(_urlPrefix, stack.name, stack.id),
    body: {
...
exports.abandonStack = function (stack, callback) {
  ...
  function abandon(stack) {
    return self._request({
      path: new URL(_urlPrefix, stack.name, stack.id, 'abandon'),
      method: 'DELETE'
