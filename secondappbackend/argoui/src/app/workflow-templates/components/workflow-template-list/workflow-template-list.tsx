...
export class WorkflowTemplateList extends BasePage<RouteComponentProps<any>, State> {
            ...
            <Consumer>
                {ctx => (
                    <Page
                        ...
                        toolbar={{
                            breadcrumbs: [{title: 'Workflow Templates', path: '/workflow-templates'}],
                            actionMenu: {
                                items: [
                                    {
    ...
    private saveHistory() {
        this.url = '/workflow-templates/' + this.namespace || '';
                    ...
                    <div className='argo-table-list'>
                        ...
                        {this.state.templates.map(t => (
                            <Link
                                ...
                                to={`/workflow-templates/${t.metadata.namespace}/${t.metadata.name}`}>
                                <div className='columns small-1'>
