            ...
            <Consumer>
                {ctx => (
                    <Page
                        ...
                        toolbar={{
                            breadcrumbs: [{title: 'Cluster Workflow Templates', path: '/cluster-workflow-templates'}],
                            actionMenu: {
                                items: [
                                    {
                        ...
                        <SlidingPanel isShown={this.sidePanel !== null} onClose={() => (this.sidePanel = null)}>
                            <ResourceEditor
                                ...
                                onSubmit={wfTmpl =>
                                    services.clusterWorkflowTemplate.create(wfTmpl).then(wf => ctx.navigation.goto(`/cluster-workflow-templates/${wf.metadata.name}`))
                                }
                            />
                            <p>
                                <ExampleManifests />.
                ...
                <div className='columns small-12'>
                    <div className='argo-table-list'>
                        ...
                        {this.state.templates.map(t => (
                            <Link className='row argo-table-list__row' key={t.metadata.uid} to={`/cluster-workflow-templates/${t.metadata.name}`}>
                                <div className='columns small-1'>
