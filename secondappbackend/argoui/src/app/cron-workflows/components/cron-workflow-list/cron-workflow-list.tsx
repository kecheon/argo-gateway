...
export class CronWorkflowList extends BasePage<RouteComponentProps<any>, State> {
            ...
            <Consumer>
                {ctx => (
                    <Page
                        ...
                        toolbar={{
                            breadcrumbs: [{title: 'Cron Workflows', path: '/cron-workflows'}],
                            actionMenu: {
                                items: [
                                    {
    ...
    private saveHistory() {
        this.url = '/cron-workflows/' + this.state.namespace || '';
                ...
                <div className='argo-table-list'>
                    ...
                    {this.state.cronWorkflows.map(w => (
                        <Link
                            ...
                            to={`cron-workflows/${w.metadata.namespace}/${w.metadata.name}`}>
